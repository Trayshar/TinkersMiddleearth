...
public class FractionSmelteryRender extends SmelteryRender {
    ...
    public boolean renderSmeltery (IBlockAccess world, int x, int y, int z, Block block, int modelID, RenderBlocks renderer)
    {
        ...
        FractionSmelteryLogic logic = (FractionSmelteryLogic) world.getTileEntity(x, y, z);
    ...
    private void renderLayer2 (FractionSmelteryLogic logic, int start, CoordTuple from, CoordTuple to, int posY, RenderBlocks renderer, IBlockAccess world)
    {
